...
function NavigationButton({ open, setOpen }) {
    return (
        <div className=''>
            {
                !open ? <div className="flex w-full">
                    <a onClick={() => setOpen(!open)} class={` w-full flex flex-row justify-center items-center h-10`}>
                        <span class="flex text-center rounded-full items-center hover:bg-gray-50 p-2  text-gray-600 hover:text-gray-800">
